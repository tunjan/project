...
export const mockChallenges: Challenge[] = [
  {
    ...
    description:
      'The chapter with the most outreach hours logged by the end of September wins bragging rights and a featured spot on the global homepage.',
  ...
  },
  {
    ...
    description:
      'The chapter that records the most vegan conversions between June and August gets a bonus grant for their next big event.',
  ...
  },
  {
    ...
    description:
      'Chapter with the most new sign-ups to the Vegan Outreach program by year-end wins a special grant.',
    metric: 'New Sign-ups',
    goal: 500,
  ...
  },
  {
    ...
    description:
      'The chapter with the highest percentage increase in Cube attendance during spring months receives new outreach equipment.',
