...
const Challenges = () => {
  ...
  return (
    <section className="py-12">
      <h2 className="text-3xl font-extrabold text-black tracking-tight border-b-2 border-[#d81313] pb-3 mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {challenges.map((challenge) => (
          <div key={challenge.id} className="bg-white border border-black p-6">
            ...
            <p className="text-neutral-600 mt-2 mb-4 text-sm">
                      ...
                      <div className="flex items-center">
                        ...
                        <span
                          className={`font-semibold ${
                            index === 0 ? "text-[#d81313]" : "text-black"
                          }`}
                        >
                          {p.name}
                        </span>
