...
describe('<Avatar />', () => {
  ...
  const mockCreateImagePreview = vi.mocked(createImagePreview);
  ...
  describe('Editable Avatar', () => {
    ...
    it('handles valid file upload', async () => {
      ...
      mockCreateImagePreview.mockResolvedValue('preview-url');
    ...
    it('handles invalid file upload', () => {
      ...
      expect(mockCreateImagePreview).not.toHaveBeenCalled();
    });
    ...
    it('handles file upload error', async () => {
      ...
      mockValidateImageFile.mockReturnValue({ isValid: true });
      mockCreateImagePreview.mockRejectedValue(new Error('Upload failed'));
