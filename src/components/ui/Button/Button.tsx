...
import { cn } from '@/utils'; // Import the new utility
...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variantClasses = {
      ...
      outline:
        'md:border-2 border-black bg-white text-black hover:bg-black hover:text-white dark:border-white dark:bg-black dark:text-white dark:hover:bg-white dark:hover:text-black',
      warning: 'bg-warning text-black hover:bg-warning-hover',
      success: 'bg-success text-white hover:bg-success-hover',
      info: 'bg-info text-white hover:bg-info-hover',
      gray: 'bg-grey-200 text-black hover:bg-grey-300 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600',
    };
