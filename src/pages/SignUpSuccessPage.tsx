...
import { CalendarIcon, ChevronRightIcon, InstagramIcon, ChatBubbleLeftRightIcon } from '@/icons';
  ...
  return (
    <div className="mx-auto w-full max-w-2xl p-6">
      <div className="card-brutal card-padding bg-primary-lightest">
        <h1 className="h-card mb-2">Thanks for applying{name ? `, ${name}` : ''}!</h1>
        <p className="text-grey-700">
          We've received your application for {chapter ? <strong>{chapter}</strong> : 'your chapter'}.
        </p>
        <div className="mt-4 rounded-none border-2 border-black bg-white p-4 shadow-brutal">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <ul className="mt-1 list-disc pl-5 text-sm text-grey-700">
                <li>An organizer from the {chapter || 'chapter'} team will review your application.</li>
                <li>Expect a decision in 3–5 days. You'll receive a notification and email if enabled.</li>
                <li>If approved, you'll be asked to get verified in person at your next event.</li>
              </ul>
            </div>
          </div>
        </div>
