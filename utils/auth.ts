...
export const getAssignableRoles = (user: User): Role[] => {
    ...
    // Regional Organisers and above can assign roles up to their own level (excluding Godmode)
