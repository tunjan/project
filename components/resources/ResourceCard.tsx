...
const MetaTag: React.FC<{ text: string; className?: string }> = ({ text, className = 'bg-neutral-100 text-neutral-800' }) => (
    <span className={`inline-block px-2 py-0.5 text-xs font-semibold ${className}`}>
        {text}
    </span>
);
    ...
    <div className="bg-white border border-black flex flex-col justify-between">
      <div className="p-5">
        <div className="flex items-center space-x-3 mb-3">
            ...
            <h3 className="text-lg font-bold text-black leading-tight">{resource.title}</h3>
        </div>
