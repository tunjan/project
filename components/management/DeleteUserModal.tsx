        ...
        >
            ...
            >
                <div className="text-center">
                    ...
                    <h2 className="mt-4 text-2xl font-extrabold text-black">Delete User</h2>
                    <p className="mt-2 text-sm text-neutral-600">
                        Are you sure you want to delete <span className="font-bold">{user.name}</span>? This action is permanent and cannot be undone.
                    </p>
                </div>
