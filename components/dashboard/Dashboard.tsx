...
import { QrCodeIcon, ShieldCheckIcon, PencilIcon, HomeIcon, InformationCircleIcon } from '../icons';
...
const Dashboard: React.FC<DashboardProps> = ({ user }) => {
  ...
  const handleSaveProfile = (updatedData: { name: string; instagram: string; hostingAvailability: boolean; hostingCapacity: number; }) => {
  ...
  return (
    ...
    {isQrModalOpen && user.identityToken && (
        <QrCodeModal token={user.identityToken} onClose={() => setIsQrModalOpen(false)} />
    )}
    {isEditModalOpen && (
        <EditProfileModal 
            user={user}
    ...
    <div className="py-8 md:py-12">
          ...
          <div className="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 mb-8" role="alert">
              <div className="flex">
                  ...
                  <div>
                      ...
                      <p className="text-sm">Your application has been approved. To gain full access, please meet a Chapter Organizer in person to have your identity verified and receive your cryptographic ID.</p>
                  </div>
              </div>
          </div>
      )}
      ...
      <div className="border border-black bg-white mb-8">
        <div className="p-6 md:p-8 flex flex-col sm:flex-row items-start">
          <img
          ...
          <div className="flex-grow text-center sm:text-left mt-4 sm:mt-0 sm:ml-8">
            ...
            {user.instagram && (
                <p className="text-sm text-neutral-500 mt-1">
                    Instagram: <a href={`https://instagram.com/${user.instagram}`} target="_blank" rel="noopener noreferrer" className="font-semibold text-[#d81313] hover:underline">@{user.instagram}</a>
                </p>
            )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
          {/* Hosting Dashboard */}
          <section>
             <h2 className="text-2xl font-bold text-black border-b-2 border-[#d81313] pb-2 mb-4">Hosting</h2>
             <HostingDashboard />
          </section>
          ...
          <section>
            <h2 className="text-2xl font-bold text-black border-b-2 border-[#d81313] pb-2 mb-4">Participation History</h2>
        ...
        <div className="lg:col-span-1 space-y-8">
          ...
          {user.identityToken && (
            <section>
                <h2 className="text-2xl font-bold text-black border-b-2 border-[#d81313] pb-2 mb-4">Verified Identity</h2>
                <div className="bg-white border border-black p-6">
                    <div className="flex items-center border-b border-black pb-4 mb-4">
                        ...
                        <h3 className="text-lg font-bold text-black">Verified Activist</h3>
                    </div>
                    <p className="text-sm text-neutral-600 mb-4">
                        Your identity is cryptographically verified. Show this QR code to an organizer for in-person verification.
                    </p>
                    <button 
